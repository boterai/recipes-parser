...
class NasloviNetExtractor(BaseRecipeExtractor):
    ...
    def extract_description(self) -> Optional[str]:
        ...
        if meta_desc and meta_desc.get('content'):
            ...
            # Извлекаем только вводную часть до "Sastojci:"/"Састојци:" или "Припрема:"/"Priprema:"
            desc = re.split(r'Sastojci:|Састојци:|Припрема:|Priprema:', desc, flags=re.IGNORECASE)[0]
    ...
    def extract_ingredients(self) -> Optional[str]:
        ...
        # Ищем текст между "Sastojci:"/"Састојци:" и "Priprema:"/"Припрема:"
        sastojci_match = re.search(r'(?:Sastojci:|Састојци:)\s*(.+?)(?:Priprema:|Припрема:|$)', desc, re.IGNORECASE | re.DOTALL)
        if sastojci_match:
    ...
    def extract_instructions(self) -> Optional[str]:
        ...
        # Ищем текст после "Priprema:"/"Припрема:"
