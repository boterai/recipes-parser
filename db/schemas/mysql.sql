...
CREATE TABLE IF NOT EXISTS sites (
    ...
    language VARCHAR(10),
    parsing_fail_count INT DEFAULT 0, -- число неудачных попыток парсинга страниц с этого сайта (для мониторинга + пропуск вечно падающих сайтов)
...
CREATE TABLE IF NOT EXISTS merged_recipes (
    ...
    is_variation BOOLEAN DEFAULT FALSE, -- является ли запись вариацией рецепта (созданной через GPT) или результатом прямого слияния рецептов из кластера
